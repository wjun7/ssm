...
import com.soecode.lyf.service.TopaidService;
...
public class PaidController {
	...
	//添加租金信息到topaid表
		@RequestMapping(value="/inserttopaid",method = RequestMethod.POST)
		public String inserttopaid(@ModelAttribute  Topaid topaid, Model model){
