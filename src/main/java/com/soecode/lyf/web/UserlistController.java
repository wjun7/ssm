...
import com.soecode.lyf.service.UserlistService;
...
public class UserlistController {
	...
	//查找并更新用户信息
	@RequestMapping(value = "/checkuserlist",method = RequestMethod.POST)
	public String checkuserlist(Model model, @ModelAttribute Userlist userlist, HttpSession httpSession) throws Exception{
